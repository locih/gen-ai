...
TOOL_SCHEMAS = [
    ...
    },
    {
        ...
        "function": {
            ...
            "description": (
                "Сравнить значение макро-метрики в двух периодах. Возвращает value, "
                "delta и ratio (b/a). Используй для «во сколько раз вырос», "
                "«на сколько изменился» между датами. metric: key_rate, fx_USD, "
                "fx_EUR, fx_CNY, cpi, unemployment. period_a/period_b: YYYY-MM "
                "или YYYY-MM-DD."
            ),
            "parameters": {
                "type": "object",
